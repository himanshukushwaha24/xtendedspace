  ...
  useEffect(() => {
    ...
    const saveData = async () => {
      ...
      try {
        ...
        if (storedata && storedData.Name && storedData.Mobile && storedData.Location && storedData.Email && storedData.AddType) {
        ...
        if (error.errors) {
          ...
          console.error('Error calling SaveMumbai API:', error);
        }
      }
    };
  ...
  return (
    <div className='packerWrapper'>
      <section className="thanks">
        ...
        <a className="thanks-btn" href="/warehouse-storage-service-in-mumbai/">Back home</a>
